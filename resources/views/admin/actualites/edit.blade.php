<x-layout titre="Modification de l'actualité">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 mx-auto w-full max-w-4xl">
            <form class="space-y-6" action="{{ route('admin.actualites.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <div>
                        <input type="textarea" id="contenu" name="contenu" col="15" row="30" value="{{ old('contenu') ?? $actualite->contenu}}">
                    </div>
                </div>
