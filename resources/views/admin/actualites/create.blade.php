<x-layout titre="Nouvelle actualité">
    ...
    <div class="mt-10 mx-auto w-full max-w-sm">
        ...
        <form class="space-y-6" action="{{route('admin.actualites.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                {{-- TITRE --}}
                <label for="titre" class="block text-sm font-medium leading-6 text-gray-900">Titre de l'actualité</label>
                <div class="mt-2">
                ...
                <div>
                    <label for="contenu" class="block text-sm font-medium leading-6 text-gray-900">Contenu de l'actualité</label>
                    <div>
            ...
            <div>
                ...
                <label for="image" class="block text-sm font-medium leading-6 text-gray-900">Image de l'actualité</label>
                <div class="mt-2">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            <a href="{{ route('admin.index') }}" class="hover:text-indigo-600">Retour aux notes</a>
        </p>
    </div>
