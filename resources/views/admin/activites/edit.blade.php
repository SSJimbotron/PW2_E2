<x-layout titre="Modification de l'activité">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 mx-auto w-full max-w-4xl">
            <form class="space-y-6" action="{{ route('admin.activites.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <div>
                        <input type="textarea" id="description" name="description" col="15" row="30" value="{{ old('description') ?? $activite->description}}">
                    </div>
                </div>
