<x-layout titre="Nouvelle activité">
    ...
    <div class="mt-10 mx-auto w-full max-w-sm">
        {{-- FORMULAIRE --}}
        <form class="space-y-6" action="{{route('admin.activites.store')}}" method="POST" enctype="multipart/form-data">
            @csrf

            <div>
                {{-- NOM --}}
                <label for="nom" class="block text-sm font-medium leading-6 text-gray-900">Nom de l'activité</label>
                <div class="mt-2">
