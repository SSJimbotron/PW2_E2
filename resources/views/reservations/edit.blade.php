            ...
            <div class="flex min-h-full flex-col justify-center px-6 py-1 lg:px-8">
                ...
                <div class="mt-10 mx-auto w-full max-w-4xl">
                    <form class="space-y-6" action="{{ route('reservations.update') }}" method="POST"
                                ...
                                <select
                                    ...
                                    @foreach ($forfaits as $forfait)
                                        @if ($forfait->id == $reservation->forfait_id)
                                            <option selected value="{{ $forfait->id }}"
                        ...
                        {{-- SUBMIT --}}
                        <div class="submit">
                            <button type="submit" class="font-quicksand" value="Modifier">Modifier la
                                réservation</button>
                        </div>
                    ...
                    {{-- SUPPRESSION --}}
                    <form action="{{ route('reservations.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="submit">
                            ...
                            <button type="submit" class="font-quicksand supprime">Supprimer la réservation</button>
                        </div>
