        ...
        <div class="forfait_carte">
            <div>
                <div>
                    ...
                    <h2 class="font-lovelo">Platine</h2>
                </div>
                <button>Réserver</button>
            </div>
            <div>
                <p class="font-quicksand">Accès exclusif aux zones VIP du festival.
        ...
        <div class="forfait_carte">
            <div>
                <div>
                    ...
                    <h2 class="font-lovelo">Or</h2>
                </div>
                <button>Réserver</button>
            </div>
            <div>
                <p class="font-quicksand">Billets pour le festival et emplacement de camping inclus.
        ...
        <div class="forfait_carte">
            <div>
                <div>
                    ...
                    <h2 class="font-lovelo">Argent</h2>
                </div>
                <button>Réserver</button>
            </div>
            <div>
                <p class="font-quicksand">Billets pour le festival à un prix abordable.
